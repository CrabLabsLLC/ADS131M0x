...
ADS131M0xError ADS131M0x_WriteRegister (const ADS131M0x* const device, const ADS131M0xRegister reg, const uint16_t value);
...
ADS131M0xError ADS131M0x_Read(const ADS131M0x* const device, void* const buffer, const uint8_t length);
